...
export function CaloriesCard({
  ...
  return (
    ...
    >
      ...
      {/* Background overlay */}
      <div className="absolute inset-0 bg-orange-500/[0.03] dark:bg-orange-500/[0.05] pointer-events-none" />
      ...
      <div className="p-6 relative z-10">
        ...
        <div className="flex items-start justify-between mb-5">
          <div>
            ...
            {calPct !== null && (
              <p className="text-sm text-muted-foreground">
                <span className="inline-block w-1.5 h-1.5 rounded-full bg-orange-500 animate-pulse mr-1.5" />
          ...
          <motion.div
            className="w-12 h-12 rounded-2xl bg-orange-500/10 flex items-center justify-center border border-border/50 shadow-sm"
            whileTap={{ scale: 0.97 }}
          >
        ...
        <div className="flex items-center gap-6 mb-5">
          ...
          >
            <div className="relative">
              ...
              <Flame className="absolute inset-0 m-auto h-4.5 w-4.5 text-orange-500" />
            </div>
            <div>
          ...
          >
            <div className="relative">
              ...
              <Droplets className="absolute inset-0 m-auto h-4.5 w-4.5 text-blue-500" />
            </div>
            <div>
