...
export function CalorieTracker() {
  ...
  return (
    ...
    >
      ...
      <div className="relative h-3 rounded-full bg-accent/10 dark:bg-accent/20 mb-5 overflow-hidden">
        <motion.div
          initial={{ width: 0 }}
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        >
          <div className="text-xs text-primary font-medium mb-1">Protein</div>
          ...
          {goal.protein_target && (
            <div className="h-1 rounded-full bg-primary/20 dark:bg-primary/30 mt-2 overflow-hidden">
              <motion.div
                initial={{ width: 0 }}
        ...
        <motion.div
          whileHover={{ scale: 1.02 }}
          className="p-3 rounded-xl bg-warning/10 dark:bg-warning/20"
        >
          <div className="text-xs text-warning font-medium mb-1">Carbs</div>
          <div className="flex items-baseline gap-1">
          ...
          {goal.carbs_target && (
            <div className="h-1 rounded-full bg-warning/20 dark:bg-warning/30 mt-2 overflow-hidden">
              <motion.div
                initial={{ width: 0 }}
        ...
        <motion.div
          whileHover={{ scale: 1.02 }}
          className="p-3 rounded-xl bg-success/10 dark:bg-success/20"
        >
          <div className="text-xs text-success font-medium mb-1">Fat</div>
          <div className="flex items-baseline gap-1">
          ...
          {goal.fat_target && (
            <div className="h-1 rounded-full bg-success/20 dark:bg-success/30 mt-2 overflow-hidden">
              <motion.div
                initial={{ width: 0 }}
